  ...
  const processFile = async (file) => {
    ...
    try {
      ...
      setDocumentInfo({
        title: file.name,
        documentType:
          json.document_analysis?.predicted_document_type || "Unknown",
        summary:
          json.document_analysis?.abstractive_summary ||
          "No summary available.",
        keyTopics: json.document_analysis?.keywords || [],
        themes: json.document_analysis?.themes || [],
        extractedEntities:
          json.key_data_points?.map((point) => ({
            label: point.label,
            type: point.entity_type,
            attributes: point.attributes || [],
          })) || [],
        keyClauses: json.key_clauses || [],
        legalTerms: json.legal_terminology || [],
      });
  ...
  return (
    <div className="flex-1 h-full p-6 bg-gray-50 overflow-auto">
      <div className="w-full mx-auto h-full flex flex-col overflow-auto">
        {/* Header */}
        <div className="mb-6">
          <h1 className="font-michroma text-3xl text-gray-900 mb-2">
            Document Assistant
          </h1>
          <p className="text-gray-600">
            Upload documents and chat with AI to extract insights and
            information
          </p>
        </div>
                ...
                >
                  {isAnalyzing ? (
                    <>
                      ...
                      <p className="text-blue-600 mb-2 text-sm lg:text-base">
                ...
                <div className="border-t p-4">
                  <div className="flex gap-2">
                    ...
                    <Button
                      ...
                      disabled={
                        !inputValue.trim() || isLoading || !documentMetadata
                      }
                      size="icon"
                    >
                ...
                {documentInfo ? (
                    ...
                    <TabsContent value="details" className="space-y-4 mt-4">
                      <div>
                        ...
                        <div className="space-y-3">
                          {documentInfo.extractedEntities &&
                          documentInfo.extractedEntities.length > 0 ? (
                            documentInfo.extractedEntities.map(
                              (entity, index) => (
                                <div
                                  key={index}
                      ...
                      <div>
                        ...
                        <div className="bg-gray-50 p-3 rounded-lg space-y-1 text-sm">
                          <p>
                            <span className="font-medium">Type:</span>{" "}
                            {documentInfo.documentType || "Unknown"}
                          </p>
                          <p>
                  ...
                  <div className="flex flex-col items-center justify-center h-full text-center">
                    ...
                    <p className="text-gray-500 text-sm">
                      Upload a document to see insights and extracted
                      information
                    </p>
                  </div>
                )}
